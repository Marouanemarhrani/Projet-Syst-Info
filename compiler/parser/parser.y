...
static int decl(const char*n,int c){if(find(n)>=0){bad("identificateur déjà déclaré");return -1;}if(na>=128){bad("mémoire des données pleine");return -1;}names[ns]=strdup(n);syms[ns]=(Sym){na++,c};return ns++;}
